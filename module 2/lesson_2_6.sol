...
contract PointsToken is IERC20 {
    ...
    event SetUserType(address user, UserType userType);
    ...
    function setUserType(address _user, UserType _type) external onlyOwner {
        userTypes[_user] = _type;
        emit SetUserType(_user, _type);
    }
